...
$(document).ready(function(){
	 ...
	 $("#addBtn").bind('click',function(){
		...
		if($("#paramsUser\\.user_hobby").val()==''){
			alert('个人兴趣不能为空');
			return;
		}
		if(!num2.exec($("#paramsUser\\.user_money").val())){
			alert('账户余额必须为数字');
			return;
		}
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
        ...
        <tr>
          ...
          <td align="right" style="padding-right:5px"><font color="red">*</font> 账户余额：</td>
          <td>
             <s:textfield type="text" id="paramsUser.user_money" name="paramsUser.user_money" value="%{#attr.user.user_money}"/>
          </td>
        </tr>   
        <tr>
          <td align="right" style="padding-right:5px"><font color="red">*</font> 个人兴趣：</td>
          <td colspan="3">
             <s:textfield cssStyle="width:300px" type="text" id="paramsUser.user_hobby" name="paramsUser.user_hobby" value="%{#attr.user.user_hobby}"/>
