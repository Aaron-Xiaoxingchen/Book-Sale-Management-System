...
function serch()
{
   document.info.action="Admin_listStockers.action";
...
function del()
{
    ...
    if(confirm('确认删除吗!?'))
    {
       document.info.action="Admin_delStockers.action?paramsUser.ids="+ids;
       document.info.submit();
    }
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">仓库管理人员&gt;&gt;仓库管理人员查询</span>
</div>
<form name="info" id="info" action="Admin_listStockers.action" method="post">
<input type="hidden" name="pageNo" id="pageNo" value="${pageNo}"/>
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  <tr><td colspan="2" height="10px">&nbsp;</td></tr>
  <tr>
    <td width="">仓库管理人员列表</td>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   <tr class="listtitle">
     ...
     <td width="220" align="center">管理仓库</td>
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center">
     	<s:iterator value="#user.stocks" id="stock"><s:property value="#stock.stock_name"/>&nbsp;&nbsp;</s:iterator>
     </td>
     <td width="" align="center"><s:property value="#user.reg_dateDesc"/></td>  
     <td width="" align="center">
       <img src="images/edit.png"/>&nbsp;<s:a href="Admin_editStocker.action?paramsUser.user_id=%{#user.user_id}">编辑</s:a>
     </td>
   </tr> 
   </s:iterator>
   </s:if>
   <s:else>
   <tr>
     <td height="60" colspan="12" align="center"><b>&lt;不存在仓库管理人员信息&gt;</b></td>
   </tr>
   </s:else>
