...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">图书订单管理&gt;&gt;图书订单查询</span>
</div>
...
<table width="95%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center"><s:property value="#orders.orders_dateDesc"/></td>
     <td width="" align="center"><s:property value="#orders.province_name"/></td>
     ...
     <td width="" align="center">
       ...
       <br/><s:a href="Admin_sendOrders.action?paramsOrders.orders_id=%{#orders.orders_id}">订单发货</s:a>&nbsp;&nbsp;
       </s:if>
       <s:if test="#orders.orders_flag!=1">
       <br/><s:a href="Admin_listLogisticss.action?paramsLogistics.orders_no=%{#orders.orders_no}">物流信息</s:a>&nbsp;&nbsp;
       </s:if>
     </td>
   </tr> 
   </s:iterator>
   ...
   <s:else>
   <tr>
     <td height="60" colspan="11" align="center"><b>&lt;不存在图书订单信息&gt;</b></td>
   </tr>
   </s:else>
