...
<title><s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>仓库管理人员信息</title>
...
$(document).ready(function(){
	 ...
	 $("#addBtn").bind('click',function(){
		...
		$("#info").attr('action','Admin_addStocker.action').submit();
	 ...
	 $("#editBtn").bind('click',function(){
		...
		$("#info").attr('action','Admin_saveStocker.action').submit();
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">仓库管理人员&gt;&gt;<s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>仓库管理人员</span>
</div>
<form id="info" name="info" action="Admin_addStocker.action" method="post">   
     ...
     <td height="24">
       <Table border="0" cellspacing="0" cellpadding="0" align="center" width="100%"> 
            <TR>
              ...
              <TD class="edittitle"><s:if test="#attr.user!=null && #attr.user.user_id!=0">编辑</s:if><s:else>添加</s:else>仓库管理人员</TD>
