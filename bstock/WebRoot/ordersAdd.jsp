	...
	<div id="list">
		 ...
		 <div class="list_info">
			 ...
			 <table class="regTable">
			    ...
			    <tr>
					<td align="right"><span style="color:red">*</span> 收货省份：</td>
					<td align="left" colspan="3">
						<s:select id="province_name" name="paramsOrders.province_name" value="" 
				      		list="#attr.plist" listKey="id" listValue="text" 
				      		class="selectstyle" cssStyle="width:205px;" headerKey="" headerValue="请选择">
				        </s:select>
					</td>
			    </tr>
			    <tr>
			    ...
			    <tr>
					...
					<td align="left" colspan="3">
						<input type="text" name="paramsOrders.user_phone" id="user_phone" value="" style="width:200px;" class="inputstyle"/>
					</td>
			    </tr> 
			    <tr>
			    	<td align="right"></td>
